  ...
  return (
    <div>
      ...
      <section className="relative h-[80vh] bg-[url('/assets/hero.png')] bg-cover bg-center bg-no-repeat w-full px-4">
        <div className="relative z-50 flex flex-col h-full justify-center items-start w-full px-6">
      ...
      <section className="py-24 bg-gray-50">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="py-10 text-sm text-gray-500">
            <p>
              Join <span className="text-blue-600 font-medium">1000+</span> other landowners
              and get your property seen 
              <br />
